commit: [6b0c8ec45a5593eee1add7ff660dad77ce524ead](https://github.com/rcmdnk/pyproject-pre-commit/tree/6b0c8ec45a5593eee1add7ff660dad77ce524ead)

condition: branch=main, os=ubuntu-latest, python_version=3.10

[![dispatch](https://github.com/rcmdnk/pyproject-pre-commit/actions/workflows/dispatch.yml/badge.svg)](https://github.com/rcmdnk/pyproject-pre-commit/actions/runs/4154426773)
...
| ----- | ------- | -------- | -------- | ------------------ |
| 5 | 0 :zzz: | 0 :x: | 0 :fire: | 0.724s :stopwatch: |
