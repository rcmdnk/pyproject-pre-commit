commit: [0d8bf19507b07c826a6ca359fbe257ad37e7d3b9](https://github.com/rcmdnk/pyproject-pre-commit/tree/0d8bf19507b07c826a6ca359fbe257ad37e7d3b9)

condition: branch=main, os=ubuntu-latest, python_version=3.10

[![dispatch](https://github.com/rcmdnk/pyproject-pre-commit/actions/workflows/dispatch.yml/badge.svg)](https://github.com/rcmdnk/pyproject-pre-commit/actions/runs/4149243067)
...
| ----- | ------- | -------- | -------- | ------------------ |
| 5 | 0 :zzz: | 0 :x: | 0 :fire: | 0.561s :stopwatch: |
