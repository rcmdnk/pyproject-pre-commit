commit: [cefc4149ea5ab278a9819c0ee1152e148a9bde4c](https://github.com/rcmdnk/pyproject-pre-commit/tree/cefc4149ea5ab278a9819c0ee1152e148a9bde4c)

condition: branch=main, os=ubuntu-latest, python_version=3.10

[![dispatch](https://github.com/rcmdnk/pyproject-pre-commit/actions/workflows/dispatch.yml/badge.svg)](https://github.com/rcmdnk/pyproject-pre-commit/actions/runs/4100101710)
...
| ----- | ------- | -------- | -------- | ------------------ |
| 5 | 0 :zzz: | 0 :x: | 0 :fire: | 0.575s :stopwatch: |
