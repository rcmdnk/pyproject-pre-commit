commit: [2701d9d5fe5d44f04397d401080edd17d3c53411](https://github.com/rcmdnk/pyproject-pre-commit/tree/2701d9d5fe5d44f04397d401080edd17d3c53411)

condition: branch=main, os=ubuntu-latest, python_version=3.10

[![dispatch](https://github.com/rcmdnk/pyproject-pre-commit/actions/workflows/dispatch.yml/badge.svg)](https://github.com/rcmdnk/pyproject-pre-commit/actions/runs/4279525987)
...
| ----- | ------- | -------- | -------- | ------------------ |
| 5 | 0 :zzz: | 0 :x: | 0 :fire: | 0.549s :stopwatch: |
