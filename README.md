commit: [16362620ec39e35051e570010484347823fb8713](https://github.com/rcmdnk/pyproject-pre-commit/tree/16362620ec39e35051e570010484347823fb8713)

condition: branch=main, os=ubuntu-latest, python_version=3.10

[![dispatch](https://github.com/rcmdnk/pyproject-pre-commit/actions/workflows/dispatch.yml/badge.svg)](https://github.com/rcmdnk/pyproject-pre-commit/actions/runs/4154396914)
...
| ----- | ------- | -------- | -------- | ------------------ |
| 5 | 0 :zzz: | 0 :x: | 0 :fire: | 0.726s :stopwatch: |
