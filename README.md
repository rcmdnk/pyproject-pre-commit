commit: [25ed250108c988d3cc4437a0e76384eeb6b41bd1](https://github.com/rcmdnk/pyproject-pre-commit/tree/25ed250108c988d3cc4437a0e76384eeb6b41bd1)

condition: branch=main, os=ubuntu-latest, python_version=3.10

[![dispatch](https://github.com/rcmdnk/pyproject-pre-commit/actions/workflows/dispatch.yml/badge.svg)](https://github.com/rcmdnk/pyproject-pre-commit/actions/runs/4181409418)
...
| ----- | ------- | -------- | -------- | ------------------ |
| 5 | 0 :zzz: | 0 :x: | 0 :fire: | 0.662s :stopwatch: |
